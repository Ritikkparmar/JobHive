  ...
  return (
    <div className="w-full px-6 py-16 rounded-2xl shadow-xl bg-white text-gray-900">
      ...
      <p className="text-center text-lg sm:text-xl mb-10 max-w-3xl mx-auto text-gray-700">
        Dive into <span className="font-semibold text-black">CareerCraft AI</span> — a smart platform where users can 
        build stunning <span className="text-purple-600 font-medium">portfolios</span>, 
        explore interactive <span className="text-pink-500 font-medium">career roadmaps</span>, 
        and get guided by an <span className="text-blue-600 font-medium">AI advisor</span> tailored to their goals.
      </p>

      <div className="flex justify-center">
        <a
          href="https://career-craft-ai.vercel.app/"
          target="_blank"
